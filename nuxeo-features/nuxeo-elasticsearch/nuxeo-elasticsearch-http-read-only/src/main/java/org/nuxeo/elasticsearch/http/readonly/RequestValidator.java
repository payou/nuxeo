...
public class RequestValidator {
    ...
    public RequestValidator() {
        ...
        for (String repositoryNames : esa.getRepositoryNames()) {
            List<String> types = new ArrayList<>();
            types.add(ElasticSearchConstants.DOC_TYPE);
            indexTypes.put(esa.getIndexNameForRepository(repositoryNames), types);
        }
    ...
    public void hasAccess(NuxeoPrincipal principal, String docAcl) throws JSONException {
        ...
        // TODO trace unauthorized access but return Not found
