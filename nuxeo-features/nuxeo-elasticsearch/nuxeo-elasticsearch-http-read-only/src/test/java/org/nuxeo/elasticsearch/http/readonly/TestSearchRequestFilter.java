...
public class TestSearchRequestFilter {
    ...
    public void testUriSearch() throws Exception {
        ...
        Assert.assertEquals("/nxutest/doc/_search?size=2", filter.getUrl());
        Assert.assertEquals(
                "{\"query\":{\"filtered\":{\"filter\":{\"terms\":{\"ecm:acl\":[\"group1\",\"group2\",\"members\",\"jdoe\",\"Everyone\"]}},\"query\":{\"query_string\":{\"query\":\"dc:title:Workspaces\"}}}}}",
                filter.getPayload());
    }
